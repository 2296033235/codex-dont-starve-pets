"""Render candidate Weber animations with Weber's own build/atlas."""
...
EMOTE_MOD = os.path.join(DS, "mods", "workshop-2649864463", "anim", "player_emotes.zip")
OUT = os.path.join(RUN, "official", "anim_ref")

WEBBER = os.path.join(ANIM, "webber.zip")
BUILD = kanim.load_build_from_zip(WEBBER)
ATLAS = ra.load_atlas(WEBBER)

CANDIDATES = [
    ("ds", "player_idles.zip", "idle_loop"),
    ("ds", "player_idles.zip", "idle"),
    ("ds", "player_idles.zip", "idle_hot_pre"),
    ("ds", "player_idles.zip", "idle_hot_loop"),
    ("ds", "player_idles.zip", "idle_hot_pst"),
    ...
    ("mod", "player_emotes.zip", "emote_happycheer"),
    ("mod", "player_emotes.zip", "emote_strikepose"),
]
