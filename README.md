...
| 文件 | 说明 |
| --- | --- |
| `final/spritesheet-extended.webp` | 最终图集，1536×2288，8×11 格，`spriteVersionNumber: 2` |
| `final/spritesheet-extended.png` | 同一图集的 PNG 版本 |
| `final/validation-extended.json` | 官方校验脚本结果：`ok: true`，无 error / 无 warning |
| `final/provenance.json` | 逐行来源记录（哪个官方动画、第几帧、朝向、缩放） |
| `scripts/` | 解码与渲染脚本（可复现整套素材） |
